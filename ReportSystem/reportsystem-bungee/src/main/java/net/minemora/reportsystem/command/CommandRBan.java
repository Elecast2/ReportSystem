...
public class CommandRBan extends Command implements TabExecutor {

	public CommandRBan() {
		super("reportban", "mod", "rban");
	}
	...
	public void execute(CommandSender sender, String[] args) {
		...
		if(args.length == 1) {
			...
			if(online) {
				ReportBanManager.ban(uid);
				player.sendMessage(TextComponent.fromLegacyText(Chat.format("&eHas negado los permisos de report a &c" + args[0])));
			}
			else {
